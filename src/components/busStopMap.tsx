      ...
      >
        ...
        {validStops.length > 0 && (
          <div className="absolute top-2 left-2 bg-black bg-opacity-70 text-white text-xs px-2 py-1 rounded">
            Showing {validStops.length} bus stop
        ...
        {userLocation && (
          <button
            ...
            className="absolute top-2 right-2 bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-full shadow-lg transition-colors z-10"
